...
// scripts/build-dictionary.mjs em src/data/ptDictionary.json). Nada de
// motores de regras (Hunspell/nspell) — só uma pesquisa num Set, instantânea
// e sem limites de tamanho.
let wordsPromise = null

function loadWords() {
  if (!wordsPromise) {
    wordsPromise = import('../data/ptDictionary.json').then((mod) => new Set(mod.default))
  }
  return wordsPromise
}
